...
class _UberOnboardingState extends State<UberOnboarding> {
  ...
  // Fonction pour naviguer vers l'écran suivant (Sélection de rôle)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // 1. Le PageView (Les pages qui défilent)
          PageView(
          ...
          // 2. Bouton "Passer" en haut à droite
          Positioned(
            top: 50,
            right: 20,
            child: TextButton(
          ...
          // 3. Indicateurs (Dots) et boutons de navigation en bas
          Positioned(
            bottom: 50,
            left: 0,
            right: 0,
  ...
  // Widget pour construire chaque page individuelle de l'onboarding
  Widget buildPage({
